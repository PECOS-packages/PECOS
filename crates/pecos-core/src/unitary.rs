...
pub use crate::unitary_rep::{
    ...
    ParseUnitaryRepError, PhaseGateError, PhaseValue, QubitPairs, Qubits, RX, RXX, RXXs, RXs, RY,
    RYY, RYYs, RYs, RZ, RZZ, RZZs, RZs, RotationType, SWAP, SWAPs, SX, SXs, SY, SYs, SZ, SZs, T,
    Ts, Unitary, UnitaryGateError, UnitaryRep, X, Xs, Y, Ys, Z, Zs, phase,
};
