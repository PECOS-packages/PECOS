...
use super::{GateId, GateSpec, GateCategory, gates};
...
impl GateRegistry {
    ...
    fn init_core_gates(&mut self) {
        // Single-qubit Paulis
        self.set_core(gates::I, GateSpec::new("I")
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::X, GateSpec::new("X")
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::Y, GateSpec::new("Y")
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::Z, GateSpec::new("Z")
            .with_category(GateCategory::SingleQubitUnitary));

        // Single-qubit Cliffords
        self.set_core(gates::H, GateSpec::new("H")
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::SX, GateSpec::new("SX")
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::SXdg, GateSpec::new("SXdg")
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::SY, GateSpec::new("SY")
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::SYdg, GateSpec::new("SYdg")
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::SZ, GateSpec::new("SZ")
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::SZdg, GateSpec::new("SZdg")
            .with_category(GateCategory::SingleQubitUnitary));

        // T gates
        self.set_core(gates::T, GateSpec::new("T")
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::Tdg, GateSpec::new("Tdg")
            .with_category(GateCategory::SingleQubitUnitary));

        // Single-qubit rotations
        self.set_core(gates::RX, GateSpec::new("RX")
            .with_angle_arity(1)
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::RY, GateSpec::new("RY")
            .with_angle_arity(1)
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::RZ, GateSpec::new("RZ")
            .with_angle_arity(1)
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::U, GateSpec::new("U")
            .with_angle_arity(3)
            .with_category(GateCategory::SingleQubitUnitary));
        self.set_core(gates::R1XY, GateSpec::new("R1XY")
            .with_angle_arity(2)
            .with_category(GateCategory::SingleQubitUnitary));

        // Two-qubit gates
        self.set_core(gates::CX, GateSpec::new("CX")
            .with_quantum_arity(2)
            .with_category(GateCategory::TwoQubitUnitary));
        self.set_core(gates::CY, GateSpec::new("CY")
            .with_quantum_arity(2)
            .with_category(GateCategory::TwoQubitUnitary));
        self.set_core(gates::CZ, GateSpec::new("CZ")
            .with_quantum_arity(2)
            .with_category(GateCategory::TwoQubitUnitary));
        self.set_core(gates::SWAP, GateSpec::new("SWAP")
            .with_quantum_arity(2)
            .with_category(GateCategory::TwoQubitUnitary));
        self.set_core(gates::ISWAP, GateSpec::new("ISWAP")
            .with_quantum_arity(2)
            .with_category(GateCategory::TwoQubitUnitary));

        // Two-qubit Clifford rotations
        self.set_core(gates::SXX, GateSpec::new("SXX")
            .with_quantum_arity(2)
            .with_category(GateCategory::TwoQubitUnitary));
        self.set_core(gates::SXXdg, GateSpec::new("SXXdg")
            .with_quantum_arity(2)
            .with_category(GateCategory::TwoQubitUnitary));
        self.set_core(gates::SYY, GateSpec::new("SYY")
            .with_quantum_arity(2)
            .with_category(GateCategory::TwoQubitUnitary));
        self.set_core(gates::SYYdg, GateSpec::new("SYYdg")
            .with_quantum_arity(2)
            .with_category(GateCategory::TwoQubitUnitary));
        self.set_core(gates::SZZ, GateSpec::new("SZZ")
            .with_quantum_arity(2)
            .with_category(GateCategory::TwoQubitUnitary));
        self.set_core(gates::SZZdg, GateSpec::new("SZZdg")
            .with_quantum_arity(2)
            .with_category(GateCategory::TwoQubitUnitary));

        // Two-qubit parameterized gates
        self.set_core(gates::CRZ, GateSpec::new("CRZ")
            .with_quantum_arity(2)
            .with_angle_arity(1)
            .with_category(GateCategory::TwoQubitUnitary));
        self.set_core(gates::RXX, GateSpec::new("RXX")
            .with_quantum_arity(2)
            .with_angle_arity(1)
            .with_category(GateCategory::TwoQubitUnitary));
        self.set_core(gates::RYY, GateSpec::new("RYY")
            .with_quantum_arity(2)
            .with_angle_arity(1)
            .with_category(GateCategory::TwoQubitUnitary));
        self.set_core(gates::RZZ, GateSpec::new("RZZ")
            .with_quantum_arity(2)
            .with_angle_arity(1)
            .with_category(GateCategory::TwoQubitUnitary));

        // Three-qubit gates
        self.set_core(gates::CCX, GateSpec::new("CCX")
            .with_quantum_arity(3)
            .with_category(GateCategory::MultiQubitUnitary));
        self.set_core(gates::CCZ, GateSpec::new("CCZ")
            .with_quantum_arity(3)
            .with_category(GateCategory::MultiQubitUnitary));
        self.set_core(gates::CSWAP, GateSpec::new("CSWAP")
            .with_quantum_arity(3)
            .with_category(GateCategory::MultiQubitUnitary));

        // Measurement
        self.set_core(gates::MEASURE, GateSpec::new("Measure")
            .with_returns_result(true)
            .with_category(GateCategory::Measurement));
        self.set_core(gates::MEASURE_LEAKED, GateSpec::new("MeasureLeaked")
            .with_returns_result(true)
            .with_category(GateCategory::Measurement));
        self.set_core(gates::MEASURE_FREE, GateSpec::new("MeasureFree")
            .with_returns_result(true)
            .with_category(GateCategory::Measurement));

        // State preparation
        self.set_core(gates::PREP, GateSpec::new("Prep")
            .with_category(GateCategory::Preparation));
        self.set_core(gates::PREP_X, GateSpec::new("PrepX")
            .with_category(GateCategory::Preparation));
        self.set_core(gates::PREP_Y, GateSpec::new("PrepY")
            .with_category(GateCategory::Preparation));

        // Qubit management
        self.set_core(gates::QALLOC, GateSpec::new("QAlloc")
            .with_category(GateCategory::QubitManagement));
        self.set_core(gates::QFREE, GateSpec::new("QFree")
            .with_category(GateCategory::QubitManagement));

        // Idle
        self.set_core(gates::IDLE, GateSpec::new("Idle")
    ...
    pub fn iter(&self) -> impl Iterator<Item = (GateId, &GateSpec)> + '_ {
        self.name_index.iter().filter_map(|(_, id)| {
            self.get(*id).map(|spec| (*id, spec))
        })
    }
}
