...
fn test_phase_zero_gate() {
    ...
    match engine.generate_commands() {
        ...
        Err(e) => {
            ...
            assert!(e.to_string().contains("p") || e.to_string().contains("phase"),
                    "Unexpected error: {}", e);
        }
    }
}
...
fn test_u_gate_identity() {
    ...
    match engine.generate_commands() {
        ...
        Err(e) => {
            ...
            assert!(e.to_string().contains("u") || e.to_string().contains("unitary"),
                    "Unexpected error: {}", e);
        }
    }
}
...
fn test_combined_phase_and_u() {
    ...
    match engine.generate_commands() {
        ...
        Err(e) => {
            ...
            assert!(e.to_string().contains("gate") || e.to_string().contains("supported"),
