...
//! use pecos_qec::fault_tolerance::dem_builder::{DetectorDef, LogicalObservable, NoiseConfig};
...
impl DemStabSimBuilder {
    ...
    /// Register logical observables by [`LogicalObservable`].
    #[must_use]
    pub fn observables(mut self, observables: Vec<LogicalObservable>) -> Self {
