...
//!
//! ```ignore
//! use pecos_qsim::density_matrix_test_utils::*;
...
///
/// ```ignore
/// use pecos_qsim::density_matrix_test_utils::{DensityMatrixSimulator, density_matrix_test_suite};
///
/// // In your test module:
...
///
/// ```ignore
/// use pecos_qsim::density_matrix_test_suite;
/// use pecos_qsim::DensityMatrix;
///
