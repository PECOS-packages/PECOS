    ...
    R: RngCore + SeedableRng + Debug,
{
    ...
    /// # Examples
    /// ```rust
    /// use pecos_qsim::{QuantumSimulator, StateVecAoS};
    ...
    /// ];
    ///
    /// let state_vec = StateVecAoS::from_state(custom_state, PecosRng::from_os_rng());
    /// ```
    ///
    /// # Panics
    ...
    R: RngCore + SeedableRng + Debug,
{
    ...
    /// # Examples
    /// ```rust
    /// use pecos_qsim::{QuantumSimulator, StateVecAoS, CliffordGateable};
