...
//! use pecos_simulators::measurement_sampler::{SequentialMeasurementSampler, MeasurementSampler};
//!
...
///
/// ```rust
/// use pecos_simulators::measurement_sampler::{MeasurementSampler, SampleResult};
/// use pecos_simulators::SymbolicSparseStab;
///
/// let mut sim = SymbolicSparseStab::new(2);
/// sim.h(&[0]).cx(&[(0, 1)]);
