...
#[cfg(feature = "num")]
pub mod linalg { pub use pecos_num::linalg::*; }
#[cfg(feature = "num")]
pub mod array { pub use pecos_num::array::*; }
#[cfg(feature = "num")]
pub mod random { pub use pecos_num::random::*; }
#[cfg(feature = "num")]
pub mod optimize { pub use pecos_num::optimize::*; }
#[cfg(feature = "num")]
pub mod polynomial { pub use pecos_num::polynomial::*; }
#[cfg(feature = "num")]
pub mod stats { pub use pecos_num::stats::*; }
#[cfg(feature = "num")]
pub mod math { pub use pecos_num::math::*; }
#[cfg(feature = "num")]
pub mod compare { pub use pecos_num::compare::*; }
#[cfg(feature = "num")]
pub mod graph { pub use pecos_num::graph::*; }
#[cfg(feature = "num")]
pub mod digraph { pub use pecos_num::digraph::*; }
#[cfg(feature = "num")]
pub mod dag { pub use pecos_num::dag::*; }
