...
void State::cx(const int_num& tqubit, const int_num& cqubit) {
...
void State::SY(const int_num& qubit) {
    /*
...
void State::SYdg(const int_num& qubit) {
    /*
    Applies a R rotation to stabilizers/destabilizers
...
void State::SZdg(const int_num& qubit) {
    /*
    X -> -iW = -Y
    Z -> Z
    W -> -iX
...
void State::SX(const int_num& qubit) {
    /*
    X -> X
    Z -> -iW = -Y
    W -> -iZ
...
void State::SXdg(const int_num& qubit) {
    /*
    X -> X
    Z -> iW = Y
    W -> iZ
...
void State::F(const int_num& qubit) {
    /*
    X -> Z
    Z -> X
    W -> -W
...
void State::Fdg(const int_num& qubit) {
    /*
    X -> Z
    Z -> iW = Y
    W -> -iX
...
void State::F2dg(const int_num& qubit) {
    /*
    X -> -iW = -Y
    Z -> -X
    W -> -iZ
...
void State::F3dg(const int_num& qubit) {
    /*
    X -> -Z
    Z -> -iW = -Y
    W -> -iX
...
void State::F4dg(const int_num& qubit) {
    /*
    X -> -iW = -Y
    Z -> X
    W -> iZ
