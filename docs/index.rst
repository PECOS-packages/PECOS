...
PECOS, which stands for "Performance Estimator of Codes On Surfaces," is a Python package that provides a framework for studying, developing, and evaluating quantum error-correcting protocols. PECOS attempts to balance simplicity, functionality, and extensibility.
