...
fn identity_ad_plus_pd_matches_paper() {
    ...
    assert_abs_diff_eq!(pl.rate(&PauliString::single(Pauli1::X)), expected_x, epsilon = 1e-12);
    assert_abs_diff_eq!(pl.rate(&PauliString::single(Pauli1::Y)), expected_y, epsilon = 1e-12);
    assert_abs_diff_eq!(pl.rate(&PauliString::single(Pauli1::Z)), expected_z, epsilon = 1e-12);
}
...
fn identity_ad_only() {
    ...
    assert_abs_diff_eq!(pl.rate(&PauliString::single(Pauli1::X)), expected_xy, epsilon = 1e-12);
    assert_abs_diff_eq!(pl.rate(&PauliString::single(Pauli1::Y)), expected_xy, epsilon = 1e-12);
    assert_abs_diff_eq!(pl.rate(&PauliString::single(Pauli1::Z)), 0.0, epsilon = 1e-12);
}
...
fn identity_pd_only() {
    ...
    let expected_z = beta_phi * tau_g / 2.0;
    assert_abs_diff_eq!(pl.rate(&PauliString::single(Pauli1::X)), 0.0, epsilon = 1e-12);
    assert_abs_diff_eq!(pl.rate(&PauliString::single(Pauli1::Y)), 0.0, epsilon = 1e-12);
    assert_abs_diff_eq!(pl.rate(&PauliString::single(Pauli1::Z)), expected_z, epsilon = 1e-12);
}
