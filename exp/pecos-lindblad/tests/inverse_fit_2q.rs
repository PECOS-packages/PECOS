...
use pecos_lindblad::{
    synthesize_numerical, Gate, PauliLindbladModel, PauliString, DEFAULT_N_STEPS,
};

fn synth_cz(t1_l: f64, t1_r: f64, t2_l: f64, t2_r: f64, omega: f64, theta: f64) -> PauliLindbladModel {
...
fn recovery_residual_small_for_pure_ad_pd() {
    ...
    assert!(residual < 1e-10, "residual for clean AD+PD should be near zero: {}", residual);
}
