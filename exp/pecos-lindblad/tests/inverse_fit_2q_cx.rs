...
use pecos_lindblad::{synthesize_numerical, Gate, PauliLindbladModel, DEFAULT_N_STEPS};

fn synth_cx(t1_l: f64, t1_r: f64, t2_l: f64, t2_r: f64, omega: f64, theta: f64) -> PauliLindbladModel {
