...
/*!
C-compatible FFI exports for PECOS Julia bindings.

This crate provides C-compatible functions that can be called from Julia via ccall.
...
pub extern "C" fn pecos_version() -> *const c_char {
    let version = CString::new("PECOS v0.1.0 (Julia bindings)")
