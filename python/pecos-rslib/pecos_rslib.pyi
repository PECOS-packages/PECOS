...
class qec:
    ...
    class DetectorErrorModel:
        ...
        def all_contribution_effects(self) -> list[Any]: ...
        ...
        def contributions_for_mechanism(self, detectors: Sequence[int]) -> list[Any]: ...
    ...
    class SampleBatch:
        ...
        def get_observable_mask(self, i: int) -> int: ...
        def get_observable_mask_wide(self, i: int) -> int: ...
    ...
    class LogicalAlgorithmDecoder:
        ...
        def feed_sparse(self, detectors: Sequence[int]) -> None: ...
        def flush(self) -> int: ...
        def decode(self, syndrome: Sequence[int]) -> int: ...
        def decode_count(self, batch: qec.SampleBatch) -> int: ...
        def reset(self) -> None: ...
        def accumulated_obs(self) -> list[bool]: ...
    ...
    class LogicalCircuitDecoder:
        ...
        def actual_num_windows(self) -> int: ...
        def effective_windowing(self) -> bool: ...
    ...
    @staticmethod
    def detector_flip_matrix(fired_per_shot: Sequence[Sequence[int]], num_detectors: int) -> list[list[float]]: ...
    @staticmethod
    ...
    @staticmethod
    def compare_flip_matrices_rs(sim: Any, dem: Any, num_detectors: int, min_rate: float = ...) -> dict[str, Any]: ...
    @staticmethod
    def compare_k_body_rates_rs(sim: Any, dem: Any, min_rate: float = ...) -> dict[str, Any]: ...
    @staticmethod
