...
class QuditStateVec:
    ...
    def apply_kraus(
        self, targets: Sequence[int], operators: Sequence[Sequence[complex]]
    ) -> KrausSample: ...
    ...
    def measure_partition(
        self, targets: Sequence[int], groups: Sequence[Sequence[int]]
    ) -> MeasurementSample: ...
...
class QutritStateVec(QuditStateVec):
    ...
    @classmethod
    def from_state(
        cls, num_sites: int, state: Sequence[complex], seed: int | None = None
    ) -> QutritStateVec: ...
    @staticmethod
...
def embedded_qubit_unitary(
    local_dimension: int, qubit_unitary: Sequence[complex]
) -> list[complex]: ...
def qutrit_leakage_channel(probability: float) -> list[list[complex]]: ...
def qutrit_seepage_channel(
    probability: float, zero_population: float
) -> list[list[complex]]: ...
