...
class KrausSample:
    """Selected state-vector Kraus trajectory branch."""
...
class MeasurementSample:
    """Selected projective-measurement outcome."""
...
class InstrumentSample:
    """Selected state-vector generalized-measurement trajectory."""
    ...
    def operator_index(self) -> int: ...
    @property
    def outcome_probability(self) -> float: ...
    @property
    def branch_probability(self) -> float: ...

class DensityMatrixDiagnostics:
    """Numerical physicality diagnostics for a density operator."""

    @property
    def trace(self) -> float: ...
    @property
    def trace_imaginary_error(self) -> float: ...
    @property
    def hermiticity_error(self) -> float: ...
    @property
    def minimum_eigenvalue(self) -> float: ...
    def is_physical(self, tolerance: float) -> bool: ...

class QuditError(Exception):
    """Base class for every error raised by the qudit reference simulators.

    The ``kind`` attribute is a stable machine-readable tag for the underlying
    condition, such as ``"LeakagePopulation"`` or ``"NotTracePreserving"``.
    """

    kind: str

class QuditValueError(QuditError, ValueError): ...
class QuditIndexError(QuditError, IndexError): ...
class QuditMemoryError(QuditError, MemoryError): ...

class QuditStateVec:
    """Rust state-vector simulator with a uniform local dimension."""

    def __init__(self, num_sites: int, local_dimension: int, seed: int | None = None) -> None: ...
    @classmethod
    def from_state(
        cls,
        num_sites: int,
    ...
    @staticmethod
    def required_memory_bytes(num_sites: int, local_dimension: int) -> int: ...
    @property
    ...
    def probability(self, basis_state: int) -> float: ...
    def outcome_probabilities(self, target: int) -> list[float]: ...
    def joint_outcome_probabilities(self, targets: Sequence[int]) -> list[float]: ...
    def apply_operator(self, targets: Sequence[int], operator: Sequence[complex]) -> None: ...
    def apply_embedded_qubit_unitary(self, target: int, qubit_unitary: Sequence[complex]) -> None: ...
    def apply_kraus(self, targets: Sequence[int], operators: Sequence[Sequence[complex]]) -> KrausSample: ...
    def instrument_probabilities(
        self, targets: Sequence[int], outcomes: Sequence[Sequence[Sequence[complex]]]
    ) -> list[float]: ...
    def measure_instrument(
        self, targets: Sequence[int], outcomes: Sequence[Sequence[Sequence[complex]]]
    ) -> InstrumentSample: ...
    def measure(self, target: int) -> int: ...
    def measure_joint(self, targets: Sequence[int]) -> MeasurementSample: ...
    def measure_partition(self, targets: Sequence[int], groups: Sequence[Sequence[int]]) -> MeasurementSample: ...
    def measure_computational(self, target: int) -> bool: ...
    def reset_site(self, target: int) -> None: ...
    def prepare_basis(self, target: int, basis_state: int) -> None: ...
    def reduced_density_matrix(self, targets: Sequence[int]) -> list[complex]: ...

class QutritStateVec(QuditStateVec):
    """QuditStateVec with local dimension fixed to three."""

    def __init__(self, num_sites: int, seed: int | None = None) -> None: ...
    @classmethod
    def from_state(cls, num_sites: int, state: Sequence[complex], seed: int | None = None) -> QutritStateVec: ...
    @staticmethod
    def required_memory_bytes(num_sites: int) -> int: ...

class QuditDensityMatrix:
    """Rust exact density-matrix simulator with a uniform local dimension."""
    ...
    def from_density_matrix(
        ...
        num_sites: int,
        local_dimension: int,
        density_matrix: Sequence[complex],
        seed: int | None = None,
    ) -> QuditDensityMatrix: ...
    @staticmethod
    def required_memory_bytes(num_sites: int, local_dimension: int) -> int: ...
    ...
    def dimension(self) -> int: ...
    @property
    def density_matrix(self) -> list[complex]: ...
    def probability(self, basis_state: int) -> float: ...
    def trace(self) -> complex: ...
    def purity(self) -> float: ...
    def diagnostics(self) -> DensityMatrixDiagnostics: ...
    def validate_physicality(self, tolerance: float) -> None: ...
    def outcome_probabilities(self, target: int) -> list[float]: ...
    def joint_outcome_probabilities(self, targets: Sequence[int]) -> list[float]: ...
    def apply_operator(self, targets: Sequence[int], operator: Sequence[complex]) -> None: ...
    def apply_embedded_qubit_unitary(self, target: int, qubit_unitary: Sequence[complex]) -> None: ...
    def apply_kraus(self, targets: Sequence[int], operators: Sequence[Sequence[complex]]) -> None: ...
    def instrument_probabilities(
        self, targets: Sequence[int], outcomes: Sequence[Sequence[Sequence[complex]]]
    ) -> list[float]: ...
    def measure_instrument(
...
class QutritDensityMatrix(QuditDensityMatrix):
    """QuditDensityMatrix with local dimension fixed to three."""

    def __init__(self, num_sites: int, seed: int | None = None) -> None: ...
    @classmethod
    def from_density_matrix(
        cls, num_sites: int, density_matrix: Sequence[complex], seed: int | None = None
    ) -> QutritDensityMatrix: ...
    @staticmethod
    def required_memory_bytes(num_sites: int) -> int: ...

def basis_swap(local_dimension: int, first: int, second: int) -> list[complex]: ...
def embedded_qubit_unitary(local_dimension: int, qubit_unitary: Sequence[complex]) -> list[complex]: ...
def qutrit_leakage_channel(probability: float) -> list[list[complex]]: ...
def qutrit_seepage_channel(probability: float, zero_fraction: float) -> list[list[complex]]: ...
