...
class StabilizerCodeSpec:
    ...
    def distance(self, max_weight: int | None = None, css: bool = False) -> DistanceResult | None: ...
    def min_weight_logicals(self, max_weight: int | None = None, css: bool = False) -> list[LogicalOperatorInfo]: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
