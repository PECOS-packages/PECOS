...
class Array(Generic[_ScalarT]):
    ...
    def __mul__(self, other: Array[Scalar] | Scalar | int | float | complex) -> Array[_ScalarT]: ...  # matmul if Array, scaling if scalar
    def __rmul__(self, other: Array[Scalar] | Scalar | int | float | complex) -> Array[_ScalarT]: ...  # matmul if Array, scaling if scalar
