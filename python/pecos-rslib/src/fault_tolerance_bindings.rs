...
impl PyDemSliceRoundSchedule {
    ...
    #[staticmethod]
    #[pyo3(signature = (output_model, templates, expected_dem_outputs, expected_tracked_paulis, coordinate_offset=None, detector_coordinate_offsets=None, dem_output_routings=None, tracked_pauli_routings=None, detector_order_routings=None))]
    fn from_templates(
        py: Python<'_>,
