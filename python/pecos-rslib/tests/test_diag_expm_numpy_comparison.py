...
class TestDiagNumpyComparison:
    ...
    def test_1d_to_2d_complex(self):
    ...
    def test_2d_to_1d_complex(self):
    ...
    def test_1d_to_2d_off_diagonal_zeros(self):
...
class TestExpmScipyComparison:
    ...
    def test_imaginary_diagonal(self):
