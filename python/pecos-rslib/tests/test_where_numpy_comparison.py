...
class TestWhereNumPyComparison:
    ...
    def test_scalar_condition_scalar_values(self):
    ...
    def test_scalar_condition_array_values(self):
    ...
    def test_array_condition_scalar_values(self):
    ...
    def test_array_condition_array_values_same_shape(self):
    ...
    def test_array_condition_mixed_scalar_array(self):
    ...
    def test_array_condition_scalar_x_array_y(self):
    ...
    def test_2d_array_condition_and_values(self):
    ...
    def test_2d_condition_with_scalar_values(self):
    ...
    def test_broadcasting_1d_to_2d(self):
    ...
    def test_comparison_with_scalar_y(self):
