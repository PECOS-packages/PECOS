...
typedef unsigned long int_num;

typedef unordered_set<int_num> int_set;
typedef vector<int_set> int_set_vec;

int_set_vec build_empty(int_num size); // Builds empty int_set_vecs.
int_set_vec build_ones(int_num size); // Builds an int_set_vecs with the diagonal filled.
