...
from pypecos.reps.pypmir.instr_type import Instr
from pypecos.reps.pypmir.op_types import Op, QOp
from pypecos.typed_list import TypedList

if TYPE_CHECKING:
    from collections.abc import Iterable

# from pypecos.reps.pypmir.op_types import Op, QOp, COp, MOp, EMOp
# from pypecos.reps.pypmir.block_types import Block
# from pypecos.reps.pypmir.data_types import Data
