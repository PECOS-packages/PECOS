...
Example:
    >>> from pecos.guppy import make_surface_code, get_n_qubits
    >>> prog = make_surface_code(distance=3, num_rounds=3, basis='Z')
    >>> n_qubits = get_n_qubits(3)
    >>> result = prog.emulator(n_qubits=n_qubits).stabilizer_sim().run()
"""
