        ...
        *,
        ...
        Raises:
            ValueError: If ``num_measurements`` disagrees with the traced
                ...
                ``meas_id``, if any idle-noise parameter is set but the final
                traced circuit has no ``Idle`` gates, or if the traced
...
def build_dem_from_guppy(
    ...
    *,
    ...
    Raises:
        ValueError: If any idle-noise parameter is set but the final traced
