...
"""Measurement operations for Qulacs-RS simulator.
...
def meas_z(state: QulacsRs, qubit: int, **_params: SimulatorGateParams) -> int:
    ...
    """
    result = state.qulacs_rs_state.run_1q_gate("MZ", qubit)
