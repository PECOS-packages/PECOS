...
"""Common type aliases and imports for PECOS, including Array type hints.

This module provides centralized imports and type aliases to ensure consistent
naming conventions throughout the PECOS codebase, including generic type support
for Array and numerical operations.
...
class Array(Generic[DType]):
    ...
    Note:
        ...
        >>> from pecos.types import Array  # Type hints only
    """
