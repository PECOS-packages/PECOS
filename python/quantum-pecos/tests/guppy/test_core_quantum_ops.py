...
class TestSingleQubitGates:
    ...
    def test_h_gate(self) -> None:
        ...
        results = (
            sim(Guppy(h_test)).qubits(10).quantum(state_vector()).seed(42).run(100).to_dict()
        )
...
class TestQuantumCircuits:
    ...
    def test_bell_state(self) -> None:
        ...
        results = (
            sim(Guppy(bell_test)).qubits(10).quantum(state_vector()).seed(42).run(100).to_dict()
        )
    ...
    def test_ghz_state(self) -> None:
        ...
        results = (
            sim(Guppy(ghz_test)).qubits(10).quantum(state_vector()).seed(42).run(100).to_dict()
        )
...
class TestControlFlow:
    ...
    def test_conditional_ops(self) -> None:
        ...
        results_true = (
            sim(Guppy(test_true_condition)).qubits(10).quantum(state_vector()).run(10).to_dict()
        )
        ...
        results_false = (
            sim(Guppy(test_false_condition)).qubits(10).quantum(state_vector()).run(10).to_dict()
        )
    ...
    @pytest.mark.skip(reason="For-loop with int return not yet supported by HUGR interpreter")
    def test_loop_with_quantum(self) -> None:
        ...
        results = (
            sim(Guppy(loop_test)).qubits(10).quantum(state_vector()).seed(42).run(100).to_dict()
        )
