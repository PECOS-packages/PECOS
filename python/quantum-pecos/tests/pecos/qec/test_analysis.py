...
class TestLogicalExtraction:
    ...
    def test_logical_z_top_row_ones(self):
...
class TestLogicalErrorRate:
    ...
    def test_error_rate_is_one_minus_fidelity(self):
        """Error rate should be 1 - fidelity."""
        correct = [0] * 9
        wrong = [1, 0, 0, 1, 0, 0, 1, 0, 0]
        outcomes = [correct] * 80 + [wrong] * 20
        err_rate, err_bar = logical_error_rate(outcomes, d=3, basis=0)
...
class TestSyndromeDifference:
    ...
    def test_two_identical_rounds(self):
    ...
    def test_alternating_syndromes(self):
...
class TestSyndromeToDetectionEvents:
    ...
    def test_first_round_events(self):
    ...
    def test_later_round_events(self):
...
class TestLowerBoundFidelity:
    ...
    def test_perfect_fidelities(self):
