...
class TestInnerCodeGeometry:
    ...
    def test_default_data_qubits(self):
    ...
    def test_num_z_stabilizers(self):
        """Should have 1 Z stabilizer."""
        inner = InnerCodeGeometry()
        assert inner.num_z_stabilizers == 1

    def test_num_syndromes(self):
...
class TestOuterCodeGeometry:
    ...
    def test_x_stabilizers_count(self):
        """Should have 4 X stabilizers."""
        outer = OuterCodeGeometry()
        assert outer.num_x_stabilizers == 4

    def test_z_stabilizers_count(self):
    ...
    def test_bulk_x_stabilizers(self):
    ...
    def test_boundary_x_stabilizers(self):
    ...
    def test_bulk_z_stabilizers(self):
    ...
    def test_boundary_z_stabilizers(self):
...
class TestMSDProtocol:
    ...
    def test_inner_init_states(self):
