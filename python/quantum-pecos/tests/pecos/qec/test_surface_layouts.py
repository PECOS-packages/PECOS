...
class TestGenerateNonrotatedSurfaceLayout:
    ...
    def test_d3_data_qubit_count(self):
        """Distance-3 non-rotated code should have 13 data qubits."""
        data, ancilla, polygons = generate_nonrotated_surface_layout(3, 3)
        assert len(data) == 13

    def test_d5_data_qubit_count(self):
        """Distance-5 non-rotated code should have 41 data qubits."""
        data, ancilla, polygons = generate_nonrotated_surface_layout(5, 5)
        assert len(data) == 41

    def test_d3_total_positions(self):
    ...
    def test_asymmetric_layout(self):
        ...
        data, ancilla, polygons = generate_nonrotated_surface_layout(3, 5)
        # 5x9 lattice
        assert len(data) + len(ancilla) == 45

    def test_data_positions_are_unique(self):
        """All data positions should be unique."""
        data, _, _ = generate_nonrotated_surface_layout(5, 5)
        assert len(data) == len(set(data))

    def test_ancilla_positions_are_unique(self):
    ...
    def test_no_overlap_data_ancilla(self):
...
class TestGenerateSurfaceLayout:
    ...
    def test_d3_data_qubit_count(self):
        ...
        data, ancilla = generate_surface_layout(3, 3)
        assert len(data) == 9
    ...
    def test_d3_ancilla_count(self):
    ...
    def test_data_at_odd_odd_positions(self):
...
class TestComputeStabilizerSupports:
    ...
    def test_boundary_stabilizers_have_weight_2(self):
    ...
    def test_stabilizer_support_is_dataclass(self):
...
class TestStabilizerCategories:
    ...
    def test_stabilizer_counts_d3(self):
    ...
    def test_stabilizer_counts_d5(self):
    ...
    def test_stabilizer_counts_d7(self):
    ...
    def test_get_bulk_stabilizers_x(self):
    ...
    def test_get_boundary_stabilizers_x(self):
    ...
    def test_get_bulk_stabilizers_z(self):
    ...
    def test_get_boundary_stabilizers_z(self):
