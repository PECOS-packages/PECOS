...
barrier sin_d, sin_a, smid_d, smid_a, sout_d, sout_a;
reset smid_d[0];
reset smid_d[1];
reset smid_d[2];
reset smid_d[3];
...
h smid_a[1];
h smid_a[2];
cx smid_a[0], smid_d[3];
// 5 -> 4
cz smid_a[1], smid_d[5];
// 6 -> 6
cz smid_a[2], smid_d[2];
// 7 -> 3
barrier sin_d, sin_a, smid_d, smid_a, sout_d, sout_a;
cz smid_a[0], smid_a[1];
barrier sin_d, sin_a, smid_d, smid_a, sout_d, sout_a;
cx smid_a[0], smid_d[0];
// 1 -> 1
cz smid_a[1], smid_d[4];
// 2 -> 5
cz smid_a[2], smid_d[3];
// 5 -> 4
cx smid_a[0], smid_d[1];
// 3 -> 2
cz smid_a[1], smid_d[2];
// 7 -> 3
cz smid_a[2], smid_d[6];
// 4 -> 7
barrier sin_d, sin_a, smid_d, smid_a, sout_d, sout_a;
cz smid_a[0], smid_a[2];
barrier sin_d, sin_a, smid_d, smid_a, sout_d, sout_a;
cx smid_a[0], smid_d[2];
// 7 -> 3
cz smid_a[1], smid_d[1];
// 3 -> 2
cz smid_a[2], smid_d[5];
// 6 -> 6
h smid_a[0];
h smid_a[1];
h smid_a[2];
...
h sout_a[1];
h sout_a[2];
cx sout_a[0], sout_d[3];
// 5 -> 4
cz sout_a[1], sout_d[5];
// 6 -> 6
cz sout_a[2], sout_d[2];
// 7 -> 3
barrier sin_d, sin_a, smid_d, smid_a, sout_d, sout_a;
cz sout_a[0], sout_a[1];
barrier sin_d, sin_a, smid_d, smid_a, sout_d, sout_a;
cx sout_a[0], sout_d[0];
// 1 -> 1
cz sout_a[1], sout_d[4];
// 2 -> 5
cz sout_a[2], sout_d[3];
// 5 -> 4
cx sout_a[0], sout_d[1];
// 3 -> 2
cz sout_a[1], sout_d[2];
// 7 -> 3
cz sout_a[2], sout_d[6];
// 4 -> 7
barrier sin_d, sin_a, smid_d, smid_a, sout_d, sout_a;
cz sout_a[0], sout_a[2];
barrier sin_d, sin_a, smid_d, smid_a, sout_d, sout_a;
cx sout_a[0], sout_d[2];
// 7 -> 3
cz sout_a[1], sout_d[1];
// 3 -> 2
cz sout_a[2], sout_d[5];
// 6 -> 6
h sout_a[0];
h sout_a[1];
h sout_a[2];
