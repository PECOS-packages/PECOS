...
h a_test[1];
h a_test[2];
cx a_test[0], q_test[3];
// 5 -> 4
cz a_test[1], q_test[5];
// 6 -> 6
cz a_test[2], q_test[2];
// 7 -> 3
barrier ;
cz a_test[0], a_test[1];
barrier ;
cx a_test[0], q_test[0];
// 1 -> 1
cz a_test[1], q_test[4];
// 2 -> 5
cz a_test[2], q_test[3];
// 5 -> 4
cx a_test[0], q_test[1];
// 3 -> 2
cz a_test[1], q_test[2];
// 7 -> 3
cz a_test[2], q_test[6];
// 4 -> 7
barrier ;
cz a_test[0], a_test[2];
barrier ;
cx a_test[0], q_test[2];
// 7 -> 3
cz a_test[1], q_test[1];
// 3 -> 2
cz a_test[2], q_test[5];
// 6 -> 6
h a_test[0];
h a_test[1];
h a_test[2];
...
if(reject_test[0] != 0) cx a_test[0], q_test[3];
// 5 -> 4
if(reject_test[0] != 0) cz a_test[1], q_test[5];
// 6 -> 6
if(reject_test[0] != 0) cz a_test[2], q_test[2];
// 7 -> 3
barrier ;
if(reject_test[0] != 0) cz a_test[0], a_test[1];
barrier ;
if(reject_test[0] != 0) cx a_test[0], q_test[0];
// 1 -> 1
if(reject_test[0] != 0) cz a_test[1], q_test[4];
// 2 -> 5
if(reject_test[0] != 0) cz a_test[2], q_test[3];
// 5 -> 4
if(reject_test[0] != 0) cx a_test[0], q_test[1];
// 3 -> 2
if(reject_test[0] != 0) cz a_test[1], q_test[2];
// 7 -> 3
if(reject_test[0] != 0) cz a_test[2], q_test[6];
// 4 -> 7
barrier ;
if(reject_test[0] != 0) cz a_test[0], a_test[2];
barrier ;
if(reject_test[0] != 0) cx a_test[0], q_test[2];
// 7 -> 3
if(reject_test[0] != 0) cz a_test[1], q_test[1];
// 3 -> 2
if(reject_test[0] != 0) cz a_test[2], q_test[5];
// 6 -> 6
if(reject_test[0] != 0) h a_test[0];
if(reject_test[0] != 0) h a_test[1];
if(reject_test[0] != 0) h a_test[2];
...
if(reject_test[0] != 0) h a_test[2];
barrier ;
if(reject_test[0] != 0) cz a_test[0], q_test[3];
// 5 -> 4
barrier ;
barrier ;
if(reject_test[0] != 0) cx a_test[1], q_test[5];
// 6 -> 6
barrier ;
barrier ;
if(reject_test[0] != 0) cx a_test[2], q_test[2];
// 7 -> 3
barrier ;
barrier ;
...
barrier ;
barrier ;
if(reject_test[0] != 0) cz a_test[0], q_test[0];
// 1 -> 1
barrier ;
barrier ;
if(reject_test[0] != 0) cx a_test[1], q_test[4];
// 2 -> 5
barrier ;
barrier ;
if(reject_test[0] != 0) cx a_test[2], q_test[3];
// 5 -> 4
barrier ;
barrier ;
if(reject_test[0] != 0) cz a_test[0], q_test[1];
// 3 -> 2
barrier ;
barrier ;
if(reject_test[0] != 0) cx a_test[1], q_test[2];
// 7 -> 3
barrier ;
barrier ;
if(reject_test[0] != 0) cx a_test[2], q_test[6];
// 4 -> 7
barrier ;
barrier ;
...
barrier ;
barrier ;
if(reject_test[0] != 0) cz a_test[0], q_test[2];
// 7 -> 3
barrier ;
barrier ;
if(reject_test[0] != 0) cx a_test[1], q_test[1];
// 3 -> 2
barrier ;
barrier ;
if(reject_test[0] != 0) cx a_test[2], q_test[5];
// 6 -> 6
barrier ;
if(reject_test[0] != 0) h a_test[0];
if(reject_test[0] != 0) h a_test[1];
