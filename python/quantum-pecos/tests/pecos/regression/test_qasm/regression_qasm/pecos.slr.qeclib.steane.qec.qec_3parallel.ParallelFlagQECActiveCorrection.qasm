...
if(flags_test != 0) h a_test[1];
if(flags_test != 0) h a_test[2];
if(flags_test != 0) cx a_test[0], q_test[2];
// X1
if(flags_test != 0) cz a_test[1], q_test[5];
// Z2
if(flags_test != 0) cz a_test[2], q_test[6];
// Z3
if(flags_test != 0) cx a_test[0], q_test[1];
// X1
if(flags_test != 0) cz a_test[1], q_test[2];
// Z2
if(flags_test != 0) cz a_test[2], q_test[5];
// Z3
if(flags_test != 0) cx a_test[0], q_test[3];
// X1
if(flags_test != 0) cz a_test[1], q_test[1];
// Z2
if(flags_test != 0) cz a_test[2], q_test[2];
// Z3
if(flags_test != 0) cx a_test[0], q_test[0];
// X1
if(flags_test != 0) cz a_test[1], q_test[4];
// Z2
if(flags_test != 0) cz a_test[2], q_test[3];
// Z3
if(flags_test != 0) h a_test[0];
if(flags_test != 0) h a_test[1];
if(flags_test != 0) h a_test[2];
