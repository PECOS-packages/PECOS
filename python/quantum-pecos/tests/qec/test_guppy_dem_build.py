...
def test_trace_once_build_evaluates_runtime_and_named_results_identically(monkeypatch: pytest.MonkeyPatch) -> None:
    calls = 0
    ...
    assert build.evaluate_results({"a": [0], "b": [1], "c": [1]}) == ([1, 1], 1)
