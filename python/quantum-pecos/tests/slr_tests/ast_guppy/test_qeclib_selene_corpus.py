...
|---|---|---|
| `Check` | qeclib/generic/check.py | data: live_preserved; ancilla: consumed; out: live_preserved |
| `Check1Flag` | qeclib/generic/check_1flag.py | live_preserved data; consumed ancilla/flag; live_preserved out/flag |
