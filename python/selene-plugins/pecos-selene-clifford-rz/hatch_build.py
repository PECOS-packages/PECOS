...
class PecosSeleneCliffordRzBuildHook(BuildHookInterface):
    ...
    def initialize(
        ...
        dist_dir = root / "python" / "pecos_selene_clifford_rz" / "_dist"
        ...
        lib_name = "pecos_selene_clifford_rz"
        cargo_package = "pecos-selene-clifford-rz"
        ...
        dest_dir = root / "python" / "pecos_selene_clifford_rz" / "_dist" / "lib"
