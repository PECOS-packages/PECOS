...
class PecosSeleneMastBuildHook(BuildHookInterface):
    ...
    def initialize(
        ...
        dist_dir = root / "python" / "pecos_selene_mast" / "_dist"
        ...
        lib_name = "pecos_selene_mast"
        cargo_package = "pecos-selene-mast"
        ...
        dest_dir = root / "python" / "pecos_selene_mast" / "_dist" / "lib"
