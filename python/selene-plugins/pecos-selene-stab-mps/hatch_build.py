...
class PecosSeleneStabMpsBuildHook(BuildHookInterface):
    ...
    def initialize(
        ...
        dist_dir = root / "python" / "pecos_selene_stab_mps" / "_dist"
        ...
        lib_name = "pecos_selene_stab_mps"
        cargo_package = "pecos-selene-stab-mps"
        ...
        dest_dir = root / "python" / "pecos_selene_stab_mps" / "_dist" / "lib"
