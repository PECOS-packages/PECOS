...
class PecosSeleStabVecBuildHook(BuildHookInterface):
    ...
    def initialize(
        ...
        dist_dir = root / "python" / "pecos_selene_stab_vec" / "_dist"
        ...
        lib_name = "pecos_selene_stab_vec"
        cargo_package = "pecos-selene-stab-vec"
        ...
        dest_dir = root / "python" / "pecos_selene_stab_vec" / "_dist" / "lib"
