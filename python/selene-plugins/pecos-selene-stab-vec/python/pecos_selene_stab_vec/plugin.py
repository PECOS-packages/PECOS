...
"""PECOS StabVec plugin for Selene."""
...
class StabVecPlugin(Simulator):
    ...
    def get_init_args(self) -> list[str]:
        ...
        -------
        list[str]
            Empty list as StabVec plugin doesn't require additional arguments.
        """
        return []
    ...
    def library_file(self) -> Path:
        ...
        if system == "darwin":
            patterns = ["libpecos_selene_stab_vec*.dylib"]
        elif system == "windows":
            patterns = ["pecos_selene_stab_vec*.dll", "pecos_selene_stab_vec*.pyd"]
        else:  # Linux and others
            patterns = ["libpecos_selene_stab_vec*.so"]
        ...
        msg = f"Could not find PECOS StabVec library in {libdir}"
