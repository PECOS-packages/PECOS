...
"""Tests for the PECOS StabVec Selene plugin."""
...
class TestStabVecBasic:
    """Basic functionality tests for the StabVec plugin."""
...
class TestStabVecArbitraryRotations:
