...
def test_telep(compare_qasm):
    ...
    for prep_basis in  ["-X", "+X", "+Y", "-Y", "+Z", "-Z"]:
        for meas_basis in ["X", "Y", "Z"]:
            ...
            compare_qasm(prog, prep_basis, meas_basis, filename="local_steane_code_program.telep")
...
def test_t_gate(compare_qasm):
    for prep_basis in  ["-X", "+X", "+Y", "-Y", "+Z", "-Z"]:
        for meas_basis in ["X", "Y", "Z"]:
            ...
            compare_qasm(prog, prep_basis, meas_basis, filename="local_steane_code_program.t_gate")
