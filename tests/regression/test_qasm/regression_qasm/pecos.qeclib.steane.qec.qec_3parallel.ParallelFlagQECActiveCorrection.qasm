...
if(syndromes_test[0] == 1) scratch_test = scratch_test  ^ 1;  // only part that differs for X vs Z syns
if(syndromes_test[1] == 1) scratch_test  = scratch_test  ^ 12;
if(syndromes_test[2] == 1) scratch_test  = scratch_test  ^ 48;

if(pf_test[1]==1) scratch_test  = scratch_test  ^ 112;  // logical operator

if(scratch_test[0] == 1) z q_test[0];
// if(scratch_test[1] == 1) z q_test[1];  // not possible for X stabilizers
